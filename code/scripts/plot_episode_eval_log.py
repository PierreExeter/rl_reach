...
if __name__ == '__main__':
    ...
    log_df.plot(x='timestep', y='norm_action1', ax=axs[2, 0])
    log_df.plot(x='timestep', y='norm_action1_min', ax=axs[2, 0], style="r--")
    log_df.plot(x='timestep', y='norm_action1_max', ax=axs[2, 0], style="r--")

    log_df.plot(x='timestep', y='norm_action2', ax=axs[2, 1])
    log_df.plot(x='timestep', y='norm_action2_min', ax=axs[2, 1], style="r--")
    log_df.plot(x='timestep', y='norm_action2_max', ax=axs[2, 1], style="r--")

    log_df.plot(x='timestep', y='norm_action3', ax=axs[2, 2])
    log_df.plot(x='timestep', y='norm_action3_min', ax=axs[2, 2], style="r--")
    log_df.plot(x='timestep', y='norm_action3_max', ax=axs[2, 2], style="r--")

    log_df.plot(x='timestep', y='norm_action4', ax=axs[2, 3])
    log_df.plot(x='timestep', y='norm_action4_min', ax=axs[2, 3], style="r--")
    log_df.plot(x='timestep', y='norm_action4_max', ax=axs[2, 3], style="r--")

    log_df.plot(x='timestep', y='norm_action5', ax=axs[2, 4])
    log_df.plot(x='timestep', y='norm_action5_min', ax=axs[2, 4], style="r--")
    log_df.plot(x='timestep', y='norm_action5_max', ax=axs[2, 4], style="r--")

    log_df.plot(x='timestep', y='norm_action6', ax=axs[2, 5])
    log_df.plot(x='timestep', y='norm_action6_min', ax=axs[2, 5], style="r--")
    log_df.plot(x='timestep', y='norm_action6_max', ax=axs[2, 5], style="r--")
    ...
    axs[1, 0].set_ylabel("Pybullet action1 (rad)")
    axs[1, 1].set_ylabel("Pybullet action2 (rad)")
    axs[1, 2].set_ylabel("Pybullet action3 (rad)")
    axs[1, 3].set_ylabel("Pybullet action4 (rad)")
    axs[1, 4].set_ylabel("Pybullet action5 (rad)")
    axs[1, 5].set_ylabel("Pybullet action6 (rad)")

    axs[2, 0].set_ylabel("Normalised action1")
    axs[2, 1].set_ylabel("Normalised action2")
    axs[2, 2].set_ylabel("Normalised action3")
    axs[2, 3].set_ylabel("Normalised action4")
    axs[2, 4].set_ylabel("Normalised action5")
    axs[2, 5].set_ylabel("Normalised action6")
