    ...
    def __init__(
        ...
        if self._renders:
            ...
            if self.camera_sensor:
                ...
                self.x_slider = p.addUserDebugParameter("x_slider", -0.5, 0.5, self.camera_target_pos[0])
                self.y_slider = p.addUserDebugParameter("y_slider", -0.5, 0.5, self.camera_target_pos[1])
                self.z_slider = p.addUserDebugParameter("z_slider", -0.5, 0.5, self.camera_target_pos[2])
                self.dist_slider = p.addUserDebugParameter("cam_dist", 0, 0.5, self._cam_dist)
