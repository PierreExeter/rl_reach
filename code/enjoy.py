...
if __name__ == "__main__":
    ...
    for t in range(args.n_eval_steps):
        ...
        if args.log_info:
            ...
            log_dict['pyb_action1'] = infos[0]['pybullet_action'][0]
            log_dict['pyb_action2'] = infos[0]['pybullet_action'][1]
            log_dict['pyb_action3'] = infos[0]['pybullet_action'][2]
            log_dict['pyb_action4'] = infos[0]['pybullet_action'][3]
            log_dict['pyb_action5'] = infos[0]['pybullet_action'][4]
            log_dict['pyb_action6'] = infos[0]['pybullet_action'][5]
            log_dict['pyb_action1_min'] = infos[0]['pybullet_action_min'][0]
            log_dict['pyb_action2_min'] = infos[0]['pybullet_action_min'][1]
            log_dict['pyb_action3_min'] = infos[0]['pybullet_action_min'][2]
            log_dict['pyb_action4_min'] = infos[0]['pybullet_action_min'][3]
            log_dict['pyb_action5_min'] = infos[0]['pybullet_action_min'][4]
            log_dict['pyb_action6_min'] = infos[0]['pybullet_action_min'][5]
            log_dict['pyb_action1_max'] = infos[0]['pybullet_action_max'][0]
            log_dict['pyb_action2_max'] = infos[0]['pybullet_action_max'][1]
            log_dict['pyb_action3_max'] = infos[0]['pybullet_action_max'][2]
            log_dict['pyb_action4_max'] = infos[0]['pybullet_action_max'][3]
            log_dict['pyb_action5_max'] = infos[0]['pybullet_action_max'][4]
            log_dict['pyb_action6_max'] = infos[0]['pybullet_action_max'][5]
            ...
            log_dict['desired_joint1_pos'] = infos[0]['desired_joint_pos'][0]
            log_dict['desired_joint2_pos'] = infos[0]['desired_joint_pos'][1]
            log_dict['desired_joint3_pos'] = infos[0]['desired_joint_pos'][2]
            log_dict['desired_joint4_pos'] = infos[0]['desired_joint_pos'][3]
            log_dict['desired_joint5_pos'] = infos[0]['desired_joint_pos'][4]
            log_dict['desired_joint6_pos'] = infos[0]['desired_joint_pos'][5]
            log_dict['joint1_vel'] = infos[0]['joint_vel'][0]
            log_dict['joint2_vel'] = infos[0]['joint_vel'][1]
            log_dict['joint3_vel'] = infos[0]['joint_vel'][2]
            log_dict['joint4_vel'] = infos[0]['joint_vel'][3]
            log_dict['joint5_vel'] = infos[0]['joint_vel'][4]
            log_dict['joint6_vel'] = infos[0]['joint_vel'][5]
            log_dict['joint1_tor'] = infos[0]['joint_tor'][0]
            log_dict['joint2_tor'] = infos[0]['joint_tor'][1]
            log_dict['joint3_tor'] = infos[0]['joint_tor'][2]
            log_dict['joint4_tor'] = infos[0]['joint_tor'][3]
            log_dict['joint5_tor'] = infos[0]['joint_tor'][4]
            log_dict['joint6_tor'] = infos[0]['joint_tor'][5]
